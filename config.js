...
FOOTER: process.env.FOOTER === undefined ? 'IMALSHA OFFICEL' : process.env.FOOTER,
CAPTION: process.env.CAPTION === undefined ? '*ɢᴇɴᴀʀᴀᴛᴇᴅ ʙʏ IMALSHA*' : process.env.CAPTION,
...
SESSION_ID: process.env.SESSION_ID === undefined ? 'ASTRO=U2glgBZa#s5RKpIBDEh6rtATE0JXq_vnXT4mUJRBQFSGDwfc4Eo4' : process.env.SESSION_ID
};
